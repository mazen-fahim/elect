...
from sqlalchemy import Interger , String , Date , ForeignKey , Enum , DateTime , func 
...
class Candidate(Base):
    ...
    organization_id : Mapped[int] = mapped_column(Interger,ForeignKey("organizations.user_id", ondelete="CASCADE"), nullable=False)
    organization_admin_id : Mapped[int] = mapped_column(Interger , ForeignKey("organization_admins.user_id", ondelete="CASCADE"), nullable=True)
