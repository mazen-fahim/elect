...
let ElectionResults = () => {
  ...
  let organization = organizations.find(
    (org) => org.id === election?.organizationId,
  );
  let electionCandidates = candidates.filter((c) =>
    election?.candidates.includes(c.id),
  );
  ...
  let sortedCandidates = [...electionCandidates].sort(
    (a, b) => b.votes - a.votes,
  );
          ...
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border border-yellow-200 p-8 mb-8">
            <div className="text-center">
              ...
              <div className="text-xl font-semibold text-gray-900">
                ...
                {getVotePercentage(winner.votes)}%)
              </div>
            </div>
          </div>
        )}
