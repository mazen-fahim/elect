        ...
        <div className="min-h-screen">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                            Empowering organizations with transparent, secure, and accessible voting solutions. From
                            student councils to political movements, we make democracy digital.
                        </p>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/50 backdrop-blur-sm">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose VoteSecure?</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200/50">
                            ...
                            <p className="text-gray-600 mb-6">
                                End-to-end encryption, voter verification, and tamper-proof ballot counting ensure your
                        ...
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200/50">
                            ...
                            <p className="text-gray-600 mb-6">
                                Intuitive dashboard for organizations to create, manage, and monitor elections with
                                real-time analytics.
                            </p>
                            <ul className="space-y-2">
                                <li className="flex items-center text-gray-700">
                        ...
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200/50">
                            ...
                            <p className="text-gray-600 mb-6">
                                Watch votes come in live with beautiful analytics and automatic result compilation and
                                reporting.
                            </p>
                            <ul className="space-y-2">
                                <li className="flex items-center text-gray-700">
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-4xl font-bold text-gray-900 mb-6">Ready to Modernize Your Elections?</h2>
