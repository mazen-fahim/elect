...
let OrganizationRegistration = () => {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage(
        "Registration successful! Your organization has been registered and is pending admin approval. You will be able to login once an administrator approves your registration. Please check your email for verification.",
      );
      setErrorMessage("");
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Join our platform and start creating secure digital elections
          </p>
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg max-w-2xl mx-auto">
            <div className="flex items-center justify-center text-blue-700">
              ...
              <span className="text-sm font-medium">
                After registration, your organization will receive a
                verification email. Then your request will be reviewed by our
                administrators.
              </span>
            </div>
          </div>
